...
/**
 * TurnsLeft is a class designed to keep track of how many turns a unit has left.
 * This is here to implement buffs and debuffs.
 */
public class TurnsLeft implements IComponent {
	 ...
	 * 
	 * 0 means no turns left for the round, while it can be >1, 1 is the default value. 
	 * Anything larger means it can do several turns on a round.
	 * 
