...
public class Weapon implements IComponent {
	...
	public Weapon(int numberOfDice, int sizeOfDice, int modifier, TargetingSystem targetingSystem,
			int aoesize, int range) { // Add things like name and other stuff to the constructor when
										// applicable.
